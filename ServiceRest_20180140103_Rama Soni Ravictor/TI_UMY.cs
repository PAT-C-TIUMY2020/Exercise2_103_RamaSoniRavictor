...
namespace ServiceRest_20180140103_Rama_Soni_Ravictor
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        public string UpdateMahasiswa(string nim, string nama, string prodi, string angkatan)
        {
            try
            {
                string constring = "Data Source=DESKTOP-D6FVKS8;Initial Catalog =\"TI UMY\";Persist Security Info=True;User ID=sa;Password=123";
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=DESKTOP-D6FVKS8;Initial Catalog =\"TI UMY\";Persist Security Info=True;User ID=sa;Password=123");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-D6FVKS8;Initial Catalog =\"TI UMY\";Persist Security Info=True;User ID=sa;Password=123");
